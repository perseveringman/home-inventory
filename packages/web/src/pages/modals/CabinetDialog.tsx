      ...
      <div className="space-y-4">
        ...
        <section className="rounded-xl bg-brand-50 p-3 space-y-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button type="button" onClick={() => pickPhoto('gallery')} className="px-3 py-2 rounded-lg bg-white border border-slate-200 text-sm inline-flex items-center gap-1.5">
              <Glyph name="image" size={16} />选图
            </button>
            <button type="button" onClick={() => pickPhoto('camera')} className="px-3 py-2 rounded-lg bg-white border border-slate-200 text-sm inline-flex items-center gap-1.5">
