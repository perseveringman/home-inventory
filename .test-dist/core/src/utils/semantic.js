...
exports.inferItemSemantic = inferItemSemantic;
exports.generateSemanticThumb = generateSemanticThumb;
const RULES = [
    // 食品 / 厨房
 ...
 * 完全本地，毫秒级。
 */
function inferItemSemantic(name, tags = [], existingEmoji) {
...
async function generateSemanticThumb(emoji, name, hue) {
    const S = 256;
