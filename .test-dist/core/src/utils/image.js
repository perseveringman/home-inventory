...
exports.cropItemFromPhoto = cropItemFromPhoto;
exports.generateItemThumb = generateItemThumb;
exports.fileToBase64 = fileToBase64;
exports.nameToHue = nameToHue;
...
function drawStickerGlyph(ctx, size, hue) {
    const cx = size / 2;
    const cy = size / 2 - 14;
    ctx.save();
...
async function generateItemThumb(name, _symbol = '') {
    const S = 160;
    const canvas = document.createElement('canvas');
    canvas.width = S;
    canvas.height = S;
